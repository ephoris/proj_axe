...
kINPUT_FEATS_DICT = {
    ...
    Policy.QHybrid: kWORKLOAD_HEADER + kSYSTEM_HEADER + ["h", "T", "Q"],
    Policy.Fluid: kWORKLOAD_HEADER + kSYSTEM_HEADER + ["h", "T", "Y", "Z"],
    Policy.Kapacity: kWORKLOAD_HEADER + kSYSTEM_HEADER + ["h", "T", "K"],
}
